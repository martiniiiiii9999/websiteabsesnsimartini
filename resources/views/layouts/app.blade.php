...
<body>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('absensi.index') ? 'active' : '' }}" href="{{ route('absensi.index') }}">
                            <i class="bi bi-plus-circle"></i> Form Absensi
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('absensi.daftar') ? 'active' : '' }}" href="{{ route('absensi.daftar') }}">
    ...
    <footer class="bg-light text-center py-3 mt-5">
        <div class="container">
            <p class="text-muted mb-0">&copy; {{ date('Y') }} Sistem Absensi. All rights reserved.</p>
        </div>
    </footer>
